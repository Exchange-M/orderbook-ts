...
class Orderbook {
    ...
    add(orderId, side, price, quantity) {
        ...
        if (side === trade_1.TRADE_SIDE.BID) { // 구매주문
            ...
            this.quantityByPriceWithBids[price] = this.quantityByPriceWithBids[price] || new decimal_1.Decimal(0);
            ...
            this.quantityByPriceWithAsks[price] = this.quantityByPriceWithAsks[price] || new decimal_1.Decimal(0);
